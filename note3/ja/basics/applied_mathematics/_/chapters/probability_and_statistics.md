...
**確率分布**とは、確率変数の取りうる値と、その値をとる確率との対応関係のこと。

### 期待値

**期待値**とは、[確率変数](#確率変数と確率分布)の全ての値に[確率](#確率)の重みをつけた加重平均。1回の[試行](#確率)で得られる結果の平均値のこと。

### 標準偏差と分散

**標準偏差**とは、[確率変数](#確率変数と確率分布)の[平均値](#平均値と中央値と最頻値)からのばらつきを表す指標。
