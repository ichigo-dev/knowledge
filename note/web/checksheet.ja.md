...
- [ ] [HTTP](/note/web/chapters/05_http.ja.md#httpの役割)
- [ ] [HTTP0.9](/note/web/chapters/05_http.ja.md#httpのバージョン)
- [ ] [HTTP1.0](/note/web/chapters/05_http.ja.md#httpのバージョン)
- [ ] [HTTP1.1](/note/web/chapters/05_http.ja.md#httpのバージョン)
	- [ ] [パイプライン](/note/web/chapters/05_http.ja.md#httpのバージョン)
	- [ ] [バーチャルホスト](/note/web/chapters/05_http.ja.md#httpのバージョン)
- [ ] [HTTP2.0](/note/web/chapters/05_http.ja.md#httpのバージョン)
- [ ] [HTTP3.0](/note/web/chapters/05_http.ja.md#httpのバージョン)
	- [ ] [QUIC](/note/web/chapters/05_http.ja.md#httpのバージョン)
- [ ] [リクエスト/レスポンス型のプロトコル](/note/web/chapters/05_http.ja.md#クライアントとサーバ)
- [ ] [同期型](/note/web/chapters/05_http.ja.md#クライアントとサーバ)
- [ ] [ユーザエージェント](/note/web/chapters/05_http.ja.md#クライアントとサーバ)
- [ ] [HTTPメッセージ](/note/web/chapters/05_http.ja.md#httpメッセージ)
	- [ ] [リクエストメッセージ](/note/web/chapters/05_http.ja.md#httpメッセージ)
	- [ ] [レスポンスメッセージ](/note/web/chapters/05_http.ja.md#httpメッセージ)
	- [ ] [スタートライン](/note/web/chapters/05_http.ja.md#httpメッセージ)
		- [ ] [リクエストライン](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [HTTPメソッド](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [リクエストURL](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [プロトコルバージョン](/note/web/chapters/05_http.ja.md#httpメッセージ)
		- [ ] [ステータスライン](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [プロトコルバージョン](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [ステータスコード](/note/web/chapters/05_http.ja.md#httpメッセージ)
			- [ ] [テキストフレーズ](/note/web/chapters/05_http.ja.md#httpメッセージ)
	- [ ] [ヘッダ](/note/web/chapters/05_http.ja.md#httpメッセージ)
	- [ ] [ボディ](/note/web/chapters/05_http.ja.md#httpメッセージ)
- [ ] [ステートレス](/note/web/chapters/05_http.ja.md#httpのステートレス性)
	- [ ] [自己記述的メッセージ](/note/web/chapters/05_http.ja.md#httpのステートレス性)
- [ ] [アプリケーション状態、セッション状態](/note/web/chapters/05_http.ja.md#httpのステートレス性)
	- [ ] [セッション](/note/web/chapters/05_http.ja.md#httpのステートレス性)
- [ ] [HTTPメソッド](/note/web/chapters/05_http.ja.md#httpの8つのメソッド)
	- [ ] [CRUD](/note/web/chapters/05_http.ja.md#httpメソッドとcrud)
	- [ ] [GET](/note/web/chapters/05_http.ja.md#get)
	- [ ] [POST](/note/web/chapters/05_http.ja.md#post)
	- [ ] [PUT](/note/web/chapters/05_http.ja.md#put)
- [ ] [冪等（べき等）](/note/web/chapters/05_http.ja.md#べき等と安全性)
- [ ] [安全性](/note/web/chapters/05_http.ja.md#べき等と安全性)
	- [ ] [副作用](/note/web/chapters/05_http.ja.md#べき等と安全性)
- [ ] [ステータスコード](/note/web/chapters/05_http.ja.md#ステータスコードの分類)
	- [ ] [200 OK](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [201 Created](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [301 Moved Permanently](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [303 See Other](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [400 Bad Request](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [401 Unauthorized](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [404 Not Found](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [500 Internal Server Error](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
	- [ ] [503 Service Unavailable](/note/web/chapters/05_http.ja.md#頻出のステータスコード)
- [ ] [HTTPヘッダ](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Date](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Content-Type](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Content-Language](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Accept](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Accept-Charset](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Accept-Language](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Content-Length](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [Transfer-Encoding: chunked](/note/web/chapters/05_http.ja.md#httpヘッダ)
	- [ ] [WWW-Authenticate](/note/web/chapters/05_http.ja.md#httpヘッダ)


## ハイパーメディアフォーマット

- [ ] [HTML](/note/web/chapters/06_hypermedia_format.ja.md#html)
	- [ ] [マークアップ言語](/note/web/chapters/06_hypermedia_format.ja.md#html)
	- [ ] [XML](/note/web/chapters/06_hypermedia_format.ja.md#html)
	- [ ] [タグ](/note/web/chapters/06_hypermedia_format.ja.md#html)
		- [ ] [開始タグ](/note/web/chapters/06_hypermedia_format.ja.md#htmlの仕様)
		- [ ] [内容（コンテンツ）](/note/web/chapters/06_hypermedia_format.ja.md#htmlの仕様)
		- [ ] [終了タグ](/note/web/chapters/06_hypermedia_format.ja.md#htmlの仕様)
	- [ ] [木構造](/note/web/chapters/06_hypermedia_format.ja.md#html)
		- [ ] [親要素、子要素](/note/web/chapters/06_hypermedia_format.ja.md#html)
	- [ ] [空要素](/note/web/chapters/06_hypermedia_format.ja.md#html)
	- [ ] [属性](/note/web/chapters/06_hypermedia_format.ja.md#html)
- [ ] [セマンティクス](/note/web/chapters/06_hypermedia_format.ja.md#セマンティクス)
	- [ ] [プログラム意味論](/note/web/chapters/06_hypermedia_format.ja.md#セマンティクス)
		- [ ] [コンパイル](/note/web/chapters/06_hypermedia_format.ja.md#セマンティクス)
	- [ ] [セマンティックWeb](/note/web/chapters/06_hypermedia_format.ja.md#セマンティクス)
- [ ] [RDF](/note/web/chapters/06_hypermedia_format.ja.md#rdf)
	- [ ] [トリプル](/note/web/chapters/06_hypermedia_format.ja.md#rdf)
- [ ] [microformats](/note/web/chapters/06_hypermedia_format.ja.md#microformats)
	- [ ] [elemental microformats](/note/web/chapters/06_hypermedia_format.ja.md#microformats)
	- [ ] [compound microformats](/note/web/chapters/06_hypermedia_format.ja.md#microformats)
- [ ] [RDFa](/note/web/chapters/06_hypermedia_format.ja.md#rdfa)
- [ ] [Atom](/note/web/chapters/06_hypermedia_format.ja.md#atom)
	- [ ] [RSS](/note/web/chapters/06_hypermedia_format.ja.md#atom)
	- [ ] [メンバリソース](/note/web/chapters/06_hypermedia_format.ja.md#atom)
		- [ ] [エントリリソース](/note/web/chapters/06_hypermedia_format.ja.md#atom)
			- [ ] [エントリ](/note/web/chapters/06_hypermedia_format.ja.md#atom)
		- [ ] [メディアリソース](/note/web/chapters/06_hypermedia_format.ja.md#atom)
			- [ ] [メディアリンクエントリ](/note/web/chapters/06_hypermedia_format.ja.md#atom)
	- [ ] [コレクションリソース](/note/web/chapters/06_hypermedia_format.ja.md#atom)
		- [ ] [フィード](/note/web/chapters/06_hypermedia_format.ja.md#atom)
- [ ] [AtomPub](/note/web/chapters/06_hypermedia_format.ja.md#atompub)
	- [ ] [サービス文書](/note/web/chapters/06_hypermedia_format.ja.md#atompub)
	- [ ] [カテゴリ文書](/note/web/chapters/06_hypermedia_format.ja.md#atompub)
- [ ] [JSON](/note/web/chapters/06_hypermedia_format.ja.md#json)
- [ ] [データ記述言語](/note/web/chapters/06_hypermedia_format.ja.md#json)
- [ ] [JSONP](/note/web/chapters/06_hypermedia_format.ja.md#jsonp)
	- [ ] [クロスドメイン通信](/note/web/chapters/06_hypermedia_format.ja.md#jsonp)
