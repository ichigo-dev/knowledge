...
**ファイル**は、[コンピュータ](../../../_/chapters/computer.md#コンピュータ)におけるデータの管理単位のひとつで、ストレージ装置などにデータを記録する際にユーザや[OS](./operating_system.md#オペレーティングシステム)から見た最小の記録単位となる。ユーザが[コンピュータ](../../../_/chapters/computer.md#コンピュータ)を用いてストレージにデータを保存、読み込み、移動、削除をする際にひとつのまとまりとしてデータの集合を表し、[ファイルシステム](#ファイルシステム)によって管理される。
