...
**値オブジェクト**は、値を[クラス](#クラス)として表現するという[オブジェクト指向](#オブジェクト指向)の設計パターン。値の概念そのものを[クラス](#クラス)として定義することで、その値に対するロジックを[高凝集](../../../computer/software/_/chapters/package.md#凝集度)にすることができる。
